...
})({"cMmiy":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "ce6b8e1937b2ac54";
"use strict";
...
},{}],"kGjbO":[function(require,module,exports,__globalThis) {
...
var _graphHopperSnapperTs = require("../../src/snapper/GraphHopperSnapper.ts");
var _graphHopperSnapperTsDefault = parcelHelpers.interopDefault(_graphHopperSnapperTs);
var _unsnappedDensifierTs = require("../../src/densifier/UnsnappedDensifier.ts");
var _unsnappedDensifierTsDefault = parcelHelpers.interopDefault(_unsnappedDensifierTs);
...
async function main() {
    ...
    const snapper = new (0, _graphHopperSnapperTsDefault.default)({
        map: map,
        url: SNAPPING_URL,
        maxDistance: 100
    });
    ...
    const densifier = new (0, _unsnappedDensifierTsDefault.default)({});
    /**
...
},{"../../src/interaction/TrackManager.ts":"7pgWz","../../src/router/GraphHopperRouter.ts":"87hBc","../../src/snapper/GraphHopperSnapper.ts":"2im2l","../../src/densifier/UnsnappedDensifier.ts":"9BN4S","../../src/profiler/index.ts":"7kdEX","./style":"b4jMm","./swisstopo":"8qItv","./track":"aPnWp","ol/events/condition":"gm0iA","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"2im2l":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class GraphHopper {
   ...
   */ nearestUrl;
    ...
    async snapPoint(point) {
        const geom = point.getGeometry();
        const mapProjection = this.map.getView().getProjection();
        const cc = (0, _projJs.toLonLat)(geom.getCoordinates().slice(0, 2), mapProjection);
        const url = `${this.nearestUrl}&point=${cc.reverse().join(',')}`;
        const response = await fetch(url);
        const json = await response.json();
        const distance = json.distance;
        if (distance === undefined) // something went wrong
        return undefined;
        if (distance > this.maxDistance) // too far, skipping
        return undefined;
        const newCoordinates = (0, _projJs.fromLonLat)(json.coordinates, mapProjection);
        if (this.maxTolerance !== Infinity && !this.isInTolerance(geom.getCoordinates(), newCoordinates)) return undefined;
    ...
    isInTolerance(pointA, pointB) {
        ...
        return (0, _coordinate.distance)(pointAPixel, pointBPixel) < this.maxTolerance;
    }
}
exports.default = GraphHopper;

},{"ol/proj.js":"8OK47","ol/coordinate":"fqHXJ","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9BN4S":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _coordinate = require("ol/coordinate");
const DEFAULT_DISTANCE = 10;
const DEFAULT_MAX_POINTS = 200;
class UnsnappedDensifier {
    distance;
    maxPoints;
    ...
    densify(segment) {
        if (segment.get("snapped")) return;
        const geometry = segment.getGeometry();
        const coordinates = geometry.getCoordinates();
        if (coordinates.length < 2) return;
        const start = coordinates[0];
        const end = coordinates[coordinates.length - 1];
        const segment_distance = (0, _coordinate.distance)(start, end);
...
exports.default = UnsnappedDensifier;

},{"ol/coordinate":"fqHXJ","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"b4jMm":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"ol/style":"kOk47","ol/color":"h6hAX","ol/geom/Point":"6SybV","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"8qItv":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@geoblocks/sources/src/Swisstopo":"2uGG2","@geoblocks/proj/src/EPSG_2056":"e378o","ol/layer/Tile":"8sJWw","ol/layer/Vector":"6bOIK","ol/source/Vector":"7wT1g","ol":"7JF0u","./style":"b4jMm","./shadowtrack":"jjGyq","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"2uGG2":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"ol/source/WMTS.js":"gTdCA","ol/tilegrid/WMTS.js":"cas0X","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"gTdCA":[function(require,module,exports,__globalThis) {
/**
 ...
 */ class WMTS extends (0, _tileImageJsDefault.default) {
   ...
   */ constructor(options){
        ...
        if (urls === undefined && options.url !== undefined) urls = (0, _uriJs.expandUrl)(options.url);
        super({
...
},{"../extent.js":"bGUel","../proj.js":"8OK47","../tilegrid/WMTS.js":"cas0X","../tileurlfunction.js":"7hwWE","../uri.js":"fEC4D","./TileImage.js":"kLfUI","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"cas0X":[function(require,module,exports,__globalThis) {
/**
...
},{"../proj.js":"8OK47","./TileGrid.js":"1y9y0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"jjGyq":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"ol/style":"kOk47","ol/source/Vector.js":"7wT1g","ol/layer/Vector.js":"6bOIK","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"aPnWp":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"ol/coordinate":"fqHXJ","ol/format/GeoJSON":"9jWnV","ol/Feature":"3qocF","ol/geom":"ce4yU","@geoblocks/proj/src/EPSG_21781":"j0BCR","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"j0BCR":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./somerc.js":"jhOnU","./utils.js":"krb2M","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["cMmiy","kGjbO"], "kGjbO", "parcelRequireed82", {})

//# sourceMappingURL=schm.37b2ac54.js.map
