...
})({"g543f":[function(require,module,exports) {
...
var _trackManagerJs = require("../../src/interaction/TrackManager.js");
var _trackManagerJsDefault = parcelHelpers.interopDefault(_trackManagerJs);
var _graphHopperJs = require("../../src/router/GraphHopper.js");
var _graphHopperJsDefault = parcelHelpers.interopDefault(_graphHopperJs);
var _indexJs = require("../../src/profiler/index.js");
var _profileJs = require("../../src/Profile.js");
...
function main() {
    const { map , trackLayer , shadowTrackLayer  } = (0, _osmJs.createMap)("map");
    const router = new (0, _graphHopperJsDefault.default)({
        url: ROUTING_URL,
        mapProjection: map.getView().getProjection()
    });
    const profiler = new (0, _indexJs.FallbackProfiler)({
        profilers: [
            new (0, _indexJs.ExtractFromSegmentProfiler)(),
            new (0, _indexJs.SwisstopoProfiler)({
   ...
   */ const altKeyAndOptionallyShift = function(mapBrowserEvent) {
    ...
    const trackManager = new (0, _trackManagerJsDefault.default)({
        map: map,
        router: router,
        profiler: profiler,
        trackLayer: trackLayer,
        shadowTrackLayer: shadowTrackLayer,
        style: (0, _styleJs.styleFunction),
        deleteCondition: deleteCondition
    });
    window.trackManager = trackManager;
    /**
   * @type {Profile}
   */ const d3Profile = new (0, _profileJsDefault.default)({
        map: map,
    ...
    d3Profile.setTrackHoverStyle(new (0, _style.Style)({
...
},{"../../src/interaction/TrackManager.js":"bPLJ7","../../src/router/GraphHopper.js":"g55Xa","../../src/profiler/index.js":"d5CmD","../../src/Profile.js":"1uxqM","./style.js":"bV6WG","ol/style":"hEQxF","./osm.js":"2SIll","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bV6WG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
var _epsg2056Js = require("@geoblocks/proj/src/EPSG_2056.js");
var _epsg2056JsDefault = parcelHelpers.interopDefault(_epsg2056Js);
...
var _shadowtrackJs = require("./shadowtrack.js");
function createMap(target) {
    const trackSource = new (0, _vectorJsDefault1.default)();
    const trackLayer = new (0, _vectorJsDefault.default)({
        source: trackSource,
        style: (0, _styleJs.styleFunction)
    });
    const extent = (0, _projJs.transformExtent)((0, _epsg2056Js.proj).getExtent(), (0, _epsg2056JsDefault.default), "EPSG:3857");
    const view = new (0, _ol.View)({
        extent: extent,
        center: (0, _projJs.transform)([
            2532661.0,
            1151654.0
        ], (0, _epsg2056JsDefault.default), "EPSG:3857"),
        zoom: 10
    });
    const bgLayer = new (0, _tileJsDefault.default)({
        source: new (0, _osmJsDefault.default)()
    });
    const shadowTrackLayer = (0, _shadowtrackJs.createShadowLayer)();
...
},{"@geoblocks/proj/src/EPSG_2056.js":"9pCNe","ol/layer/Tile.js":"3ytzs","ol/source/OSM.js":"dmxOv","ol/layer/Vector.js":"iTrAy","ol/source/Vector.js":"9w7Fr","ol":"3a1E4","./style.js":"bV6WG","ol/proj.js":"SznqC","./shadowtrack.js":"gmvf6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dmxOv":[function(require,module,exports) {
/**
...
},{"ol/style":"hEQxF","ol/source/Vector.js":"9w7Fr","ol/layer/Vector.js":"iTrAy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["g543f","f4bRs"], "f4bRs", "parcelRequireed82")
